...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-i99srvta7u">Show
  modal</button>

<div data-modal id="modal-i99srvta7u" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-i99srvta7u-label" aria-describedby="modal-i99srvta7u-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-i99srvta7u-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-i99srvta7u-heading">Modal heading</p>
