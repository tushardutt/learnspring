...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-8z0mcg68sfx">Show
  modal</button>

<div data-modal id="modal-8z0mcg68sfx" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-8z0mcg68sfx-label" aria-describedby="modal-8z0mcg68sfx-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-8z0mcg68sfx-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-8z0mcg68sfx-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
