...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-7sjxkgcgxtm">Show
  modal</button>

<div data-modal id="modal-7sjxkgcgxtm" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-7sjxkgcgxtm-label" aria-describedby="modal-7sjxkgcgxtm-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-7sjxkgcgxtm-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-7sjxkgcgxtm-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
