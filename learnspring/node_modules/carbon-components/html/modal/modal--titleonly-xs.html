...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-caxz15v5jv6">Show
  modal</button>

<div data-modal id="modal-caxz15v5jv6" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-caxz15v5jv6-label" aria-describedby="modal-caxz15v5jv6-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-caxz15v5jv6-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-caxz15v5jv6-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
