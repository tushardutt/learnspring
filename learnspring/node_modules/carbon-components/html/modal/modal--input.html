...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-cfzcst0oh5q">Show
  modal</button>

<div data-modal id="modal-cfzcst0oh5q" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-cfzcst0oh5q-label" aria-describedby="modal-cfzcst0oh5q-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-cfzcst0oh5q-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-cfzcst0oh5q-heading">Modal heading</p>
    ...
    <div class="bx--modal-content bx--modal-content--with-form" >
      <div class="bx--form-item">
        <label for="text-input-cfzcst0oh5q" class="bx--label">Text Input label</label>
        <input id="text-input-cfzcst0oh5q" type="text" class="bx--text-input" placeholder="Optional placeholder text"
