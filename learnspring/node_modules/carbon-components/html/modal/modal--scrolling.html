...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-paxymf8j8kd">Show
  modal</button>

<div data-modal id="modal-paxymf8j8kd" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-paxymf8j8kd-label" aria-describedby="modal-paxymf8j8kd-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-paxymf8j8kd-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-paxymf8j8kd-heading">Modal heading</p>
