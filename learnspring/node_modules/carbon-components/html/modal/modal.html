...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-jv8xaa2jn">Show
  modal</button>

<div data-modal id="modal-jv8xaa2jn" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-jv8xaa2jn-label" aria-describedby="modal-jv8xaa2jn-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-jv8xaa2jn-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-jv8xaa2jn-heading">Modal heading</p>
