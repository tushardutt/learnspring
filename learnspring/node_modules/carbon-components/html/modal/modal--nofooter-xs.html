...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-kumrvnhoshg">Show
  modal</button>

<div data-modal id="modal-kumrvnhoshg" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-kumrvnhoshg-label" aria-describedby="modal-kumrvnhoshg-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-kumrvnhoshg-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-kumrvnhoshg-heading">Modal heading</p>
