...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-21rwdpr2eix">Show
  modal</button>

<div data-modal id="modal-21rwdpr2eix" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-21rwdpr2eix-label" aria-describedby="modal-21rwdpr2eix-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-21rwdpr2eix-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-21rwdpr2eix-heading">Modal heading</p>
