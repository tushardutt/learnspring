...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-v77035zsc4">Show
  modal</button>

<div data-modal id="modal-v77035zsc4" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-v77035zsc4-label" aria-describedby="modal-v77035zsc4-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-v77035zsc4-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-v77035zsc4-heading">Modal heading</p>
