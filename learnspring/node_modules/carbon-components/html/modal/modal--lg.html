...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-xzekp9zr34i">Show
  modal</button>

<div data-modal id="modal-xzekp9zr34i" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-xzekp9zr34i-label" aria-describedby="modal-xzekp9zr34i-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-xzekp9zr34i-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-xzekp9zr34i-heading">Modal heading</p>
