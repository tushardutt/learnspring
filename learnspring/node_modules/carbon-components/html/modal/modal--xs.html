...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-82efpbhvbqu">Show
  modal</button>

<div data-modal id="modal-82efpbhvbqu" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-82efpbhvbqu-label" aria-describedby="modal-82efpbhvbqu-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-82efpbhvbqu-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-82efpbhvbqu-heading">Modal heading</p>
