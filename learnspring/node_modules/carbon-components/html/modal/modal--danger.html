...
<button class="bx--btn bx--btn--danger" type="button" data-modal-target="#modal-oyg5fek8oz">Show
  modal</button>

<div data-modal id="modal-oyg5fek8oz" class="bx--modal bx--modal--danger" role="dialog"
  aria-modal="true" aria-labelledby="modal-oyg5fek8oz-label" aria-describedby="modal-oyg5fek8oz-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-oyg5fek8oz-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-oyg5fek8oz-heading">Modal heading</p>
